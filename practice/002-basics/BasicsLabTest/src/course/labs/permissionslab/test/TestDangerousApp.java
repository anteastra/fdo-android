...
public class TestDangerousApp extends ActivityInstrumentationTestCase2<ActivityLoaderActivity> {
	...
	public void testRun() {
		...
		assertTrue("course.labs.permissionslab.ActivityLoaderActivity is not found!", solo.waitForActivity(course.labs.basics.ActivityLoaderActivity.class));
		...
		assertTrue("course.labs.permissionslab.BookmarksActivity is not found!", solo.waitForActivity(course.labs.basics.BookmarksActivity.class));
		...
		assertTrue("course.labs.permissionslab.GoToDangerousActivity is not found!", solo.waitForActivity(course.labs.basics.GoToDangerousActivity.class));
